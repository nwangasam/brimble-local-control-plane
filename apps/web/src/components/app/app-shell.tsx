  ...
  return (
    <main className="min-h-screen px-4 py-4 text-foreground sm:px-5 lg:px-6">
      <div className="mx-auto flex w-full max-w-7xl flex-col gap-4">
        <header className="surface-panel flex flex-wrap items-center justify-between gap-3 rounded-md border border-border/70 px-4 py-3">
          <div className="flex min-w-0 items-center gap-3">
            <div className="flex size-10 items-center justify-center rounded-md border border-border/70 bg-background">
              <Waypoints className="size-4 text-primary" />
            </div>
            <div className="min-w-0">
              <p className="truncate text-sm font-medium">Brimble Control Plane</p>
              <p className="truncate text-xs text-muted-foreground">Deployments, builds, logs</p>
            </div>
          </div>
